<amp-sidebar id="header-sidebar" class="ampstart-sidebar px3 " layout="nodisplay">
	...
	<nav class="ampstart-sidebar-nav ampstart-nav">
		<ul class="list-reset m0 p0 ampstart-label">
				...
				<amp-accordion layout="container" disable-session-states="" class="ampstart-dropdown">
					<section>
						...
						<ul class="ampstart-dropdown-items list-reset m0 p0">
							...
							<li class="ampstart-dropdown-item">
                                <a href="http://localhost:8888/amp-wp-plugin-dev/2017/07/06/youtube-test-post/amp" class="text-decoration-none">
									<?php esc_html_e( 'YouTube', 'amp' ); ?>
                                </a>
                            </li>
						</ul>
					</section>
			...
			<li class="ampstart-nav-item ampstart-nav-dropdown relative">
				...
				<amp-accordion layout="container" disable-session-states="" class="ampstart-dropdown">
                    <section>
                        <header>Set Two</header>
                        <ul class="ampstart-dropdown-items list-reset m0 p0">
                            <li class="ampstart-dropdown-item">
                                <a href="http://localhost:8888/amp-wp-plugin-dev/2017/05/26/hello-world/amp/" class="text-decoration-none">
									<?php esc_html_e( 'Hello World!', 'amp' ); ?>
                                </a>
                            </li>
                            <li class="ampstart-dropdown-item">
                                <a href="http://localhost:8888/amp-wp-plugin-dev/2017/05/30/vimeo-is-in-the-house/amp" class="text-decoration-none">
									<?php esc_html_e( 'Vimeo', 'amp' ); ?>
                                </a>
                            </li>
                        </ul>
                    </section>
	...
	<ul class="ampstart-sidebar-faq list-reset m0">
		<li class="ampstart-faq-item">
            <a href="<?php echo esc_url( get_permalink( get_page_by_title( 'About the Tests' ) ) ); ?>" class="text-decoration-none">
                <?php esc_html_e( 'About', 'amp' ); ?>
            </a>
        </li>
        <li class="ampstart-faq-item">
            <a href="<?php echo esc_url( get_permalink( get_page_by_title( 'Contact' ) ) ); ?>" class="text-decoration-none">
				<?php esc_html_e( 'Contact', 'amp' ); ?>
            </a>
        </li>
	</ul>
    <a href=""></a>
