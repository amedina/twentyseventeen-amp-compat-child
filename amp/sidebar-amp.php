<amp-sidebar id="header-sidebar" class="ampstart-sidebar px3 " layout="nodisplay">
	...
	<nav class="ampstart-sidebar-nav ampstart-nav">
		<ul class="list-reset m0 p0 ampstart-label">
            <li class="ampstart-nav-item ampstart-nav-dropdown relative">
                <div class="home-in-sidebar">
                    <a href="<?php echo esc_url( home_url() ); ?>" class="text-decoration-none">
                        <?php esc_html_e( 'Home', 'amp' ); ?>
                    </a>
                </div>
            </li>
			<li class="ampstart-nav-item ampstart-nav-dropdown relative">
                <!-- Start Dropdown-inline -->
				<?php if ( is_active_sidebar( 'amp-sidebar-1' ) ) { ?>
                            ...
                            <ul class="ampstart-dropdown-items list-reset m0 p0">
                                <li class="ampstart-dropdown-item">
                                    <div class="widget-column footer-widget-1">
		                                <?php dynamic_sidebar( 'amp-sidebar-1' ); ?>
                                    </div>
                                </li>
                            </ul>
                        </section>
				...
				<?php } ?>
				<?php if ( is_active_sidebar( 'amp-sidebar-2' ) ) { ?>
                    <amp-accordion layout="container" disable-session-states="" class="ampstart-dropdown">
                        <section>
                            <header>Pages</header>
                            <ul class="ampstart-dropdown-items list-reset m0 p0">
                                <li class="ampstart-dropdown-item">
                                    <div class="widget-column footer-widget-2">
                                        <?php dynamic_sidebar( 'amp-sidebar-2' ); ?>
                                    </div>
                                </li>
                            </ul>
                        </section>
	...
	<ul class="ampstart-sidebar-faq list-reset m0">
		<li class="ampstart-faq-item">
            <a href="<?php echo esc_url( get_permalink( get_page_by_title( 'About' ) ) ); ?>" class="text-decoration-none">
